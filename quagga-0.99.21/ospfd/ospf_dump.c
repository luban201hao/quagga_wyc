...
const struct message ospf_ism_state_msg[] =
{
  ...
  { ISM_Backup,       "Backup" },
  { ISM_DR,           "DR" },
  { ISM_Leaving,      "ISM_Leaving"},
  { ISM_Testing,      "ISM_Testing"},
  { ISM_INTEROA,      "i_ioa"},
  { ISM_INTEROA_LEAVING, "i_ioa_leaving"},
  { ISM_INTEROA_TESTING, "i_ioa_testing"},
  { ISM_SE,            "ISM_SE"},
};
...
const struct message ospf_nsm_state_msg[] =
{
  ...
  { NSM_Loading,    "Loading" },
  { NSM_Full,       "Full" },
  { NSM_Leaving,     "NSM_Leaving" },
  { NSM_Testing,     "NSM_Testing" },
  { NSM_INTEROA,     "n_ioa" },
  { NSM_INTEROA_LEAVING, "n_ioa_leaving"},
  { NSM_INTEROA_TESTING, "n_ioa_tesing"},

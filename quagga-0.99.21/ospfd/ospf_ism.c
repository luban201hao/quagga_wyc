  ...
  switch (oi->state)
    ...
    case ISM_PointToPoint:
	 ...
	 neighboring router. Hello packets are also sent. */
      /* send first hello immediately */
      //zlog_debug("timer set in ism_p2p");
      OSPF_ISM_TIMER_MSEC_ON (oi->t_hello, ospf_hello_timer, 1);      
      OSPF_ISM_TIMER_OFF (oi->t_wait);
    ...
    case ISM_INTEROA:
      ...
      OSPF_ISM_TIMER_OFF (oi->t_ls_ack);      
      break;
    case ISM_INTEROA_LEAVING:
      OSPF_ISM_TIMER_OFF(oi->t_wait);
      OSPF_ISM_TIMER_OFF(oi->t_hello);
      OSPF_ISM_TIMER_OFF(oi->t_ls_ack);
      break;
    case ISM_INTEROA_TESTING:
      OSPF_HELLO_TIMER_ON (oi);
      OSPF_ISM_TIMER_OFF (oi->t_wait);
      OSPF_ISM_TIMER_OFF (oi->t_ls_ack);    
      break;
...
ism_interface_up (struct ospf_interface *oi)
{
  ...
  {
    next_state=ISM_INTEROA;
  }
  else if (oi->type ==OSPF_IFTYPE_SE)
  {
    oi->se_hasup_flag=SE_HASUP;
    next_state=ISM_SE;
  }
...
{
  {
    ...
    { ism_ignore,          ISM_DependUpon },    /* PredicedLinkDown */
    { ism_ignore,          ISM_DependUpon },    /* PredicedLinkUp */
    { ism_ignore,          ISM_DependUpon },    /* BeginTesting        */
  },
  {
    /* Down:*/
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_begin_leaving,       ISM_Down },    /* PredicedLinkDown */
    { ism_ignore,         ISM_Down },    /* PredicedLinkUp */
    { ism_ignore,         ISM_Down },    /* BeginTesting        */
  },
  {
    /* Loopback: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_ignore,          ISM_Down },          /* UnloopInd      */
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,        ISM_Leaving },    /* PredicedLinkDown */
    { ism_ignore,          ISM_Loopback },    /* PredicedLinkUp */    // linkdown do not influence loopback interface
    { ism_ignore,          ISM_DependUpon },    /* BeginTesting        */
  },
  {
    /* Waiting: */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,          ISM_Down },    /* PredicedLinkDown */
    { ism_ignore,          ISM_Waiting },    /* PredicedLinkUp */
    { ism_ignore,          ISM_Waiting },    /* BeginTesting        */
  },
  {
    /* Point-to-Point: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,        ISM_Leaving },    /* PredicedLinkDown */
    { ism_end_leaving,          ISM_PointToPoint },    /* PredicedLinkUp */
    { ism_ignore,               ISM_PointToPoint },    /* BeginTesting        */
  },
  {
    /* DROther: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Down },    /* PredicedLinkDown */
    { ism_end_leaving,     ISM_DROther },    /* PredicedLinkUp */
    { ism_ignore,          ISM_DROther },    /* BeginTesting        */
  },
  {
    /* Backup: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Down },          /* PredicedLinkDown */
    { ism_end_leaving,     ISM_Backup },        /* PredicedLinkUp */
    { ism_ignore,          ISM_Backup },        /* BeginTesting   */
  },
  {
    /* DR: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    ...
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Down },    /* PredicedLinkDown */
    { ism_end_leaving,     ISM_DR },    /* PredicedLinkUp */
    { ism_ignore,          ISM_DR },    /* BeginTesting        */
  },
  {
    /* ISM_Leaving: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    { ism_ignore,          ISM_Leaving },            /* InterfaceUp    */
    { ism_ignore,          ISM_Leaving },            /* WaitTimer      */
    { ism_ignore,          ISM_Leaving },            /* BackupSeen     */
    { ism_neighbor_change, ISM_DependUpon },    /* NeighborChange */
    { ism_loop_ind,        ISM_Loopback },      /* LoopInd        */
    { ism_ignore,          ISM_Leaving },       /* UnloopInd      */
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_Leaving },       /* PredicedLinkDown */
    { ism_end_leaving,     ISM_Testing },  /* PredicedLinkUp */
    { ism_begin_testing,   ISM_Testing },    /* BeginTesting        */
  },
  {
    /* ISM_Testing: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
  ...
  {  //inter_oa and inter_oa_testing all need send hello, there is no difference 
    /* ISM_INTER_OA: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    { ism_ignore,          ISM_INTEROA },            /* InterfaceUp    */
    { ism_ignore,          ISM_INTEROA },            /* WaitTimer      */
    { ism_ignore,          ISM_INTEROA },            /* BackupSeen     */
    { ism_ignore,          ISM_INTEROA },    /* NeighborChange */
    { ism_ignore,          ISM_INTEROA },      /* LoopInd        */
    { ism_ignore,          ISM_INTEROA },       /* UnloopInd      */
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,   ISM_INTEROA_LEAVING },    /* PredicedLinkDown */
    { ism_end_leaving,     ISM_INTEROA },    /* PredicedLinkUp */
    { ism_begin_testing,   ISM_INTEROA },   /* BeginTesting    */
  },
  {
    /* ISM_INTER_OA_LEAVING: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    { ism_ignore,          ISM_INTEROA_LEAVING },            /* InterfaceUp    */
    { ism_ignore,          ISM_INTEROA_LEAVING },            /* WaitTimer      */
    { ism_ignore,          ISM_INTEROA_LEAVING },            /* BackupSeen     */
    { ism_ignore,          ISM_INTEROA_LEAVING },    /* NeighborChange */
    { ism_ignore,          ISM_INTEROA_LEAVING },      /* LoopInd        */
    { ism_ignore,          ISM_INTEROA_LEAVING },       /* UnloopInd      */
    { ism_interface_down,  ISM_Down },          /* InterfaceDown  */
    { ism_begin_leaving,        ISM_INTEROA_LEAVING },    /* PredicedLinkDown */
    { ism_end_leaving,          ISM_INTEROA_LEAVING },    /* PredicedLinkUp */ //don't response pre_linkup
    { ism_begin_testing,        ISM_INTEROA_TESTING },    /* BeginTesting        */
  },
  {
    /* ISM_INTER_OA_TESTING: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    { ism_ignore,          ISM_Leaving },            /* InterfaceUp    */
    { ism_ignore,          ISM_Leaving },            /* WaitTimer      */
    { ism_ignore,          ISM_Leaving },            /* BackupSeen     */
  ...
  },
  {
    /* ISM_SE: */
    { ism_ignore,          ISM_DependUpon },    /* NoEvent        */
    { ism_ignore,          ISM_SE },            /* InterfaceUp    */
    { ism_ignore,          ISM_SE },            /* WaitTimer      */
    { ism_ignore,          ISM_SE },            /* BackupSeen     */
    { ism_ignore,          ISM_SE },    /* NeighborChange */
    { ism_ignore,          ISM_SE },      /* LoopInd        */
    { ism_ignore,          ISM_SE },       /* UnloopInd      */
    { ism_ignore,          ISM_SE },          /* InterfaceDown  */
    { ism_ignore,          ISM_SE },    /* PredicedLinkDown */
    { ism_ignore,          ISM_SE },    /* PredicedLinkUp */
    { ism_ignore,          ISM_SE },    /* BeginTesting  */
  },
};  
...
if(oi->state==ISM_INTEROA || oi->state==ISM_INTEROA_LEAVING || oi->state==ISM_INTEROA_TESTING || oi->state==ISM_SE )
{

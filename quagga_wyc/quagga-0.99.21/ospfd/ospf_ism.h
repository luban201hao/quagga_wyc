...
#define ISM_Backup                        6
#define ISM_DR                            7
#define ISM_Leaving                       8 
#define ISM_Testing                       9
#define ISM_INTEROA                       10
#define ISM_INTEROA_LEAVING               11
#define ISM_INTEROA_TESTING               12
#define ISM_SE                            13
#define OSPF_ISM_STATE_MAX   	            14
...
#define ISM_PredictedLinkDown             8
#define ISM_PredictedLinkUp               9
#define ISM_BeginTesting                 10
#define OSPF_ISM_EVENT_MAX               11

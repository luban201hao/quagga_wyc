...
struct ospf_neighbor
{
  ...
  struct thread *t_test;
  struct thread *t_predown;
  ...
  struct ospf_lsdb newLSAsList;
  u_char testing_flag;

  #define NSM_IN_FIRST_TESTING_FLAG 0
  #define NSM_FIRST_TESTING_SUCCESS_FLAG 1
  #define NSM_FIRST_TESTING_FAIL_FLAG 2 // if other testing fail, stay in this status
  #define NSM_OTHER_TESTING_SUCCESS_FLAG 3
};
